...
#
# Write a function named `apply_
# discount` that takes a product's price and a discount percentage (from 0 to 100).
...
#
# Define the function and then call it below.
def basicCalculator(op1, op2, operator):
    ...
    return eval(str(op1) + operator + str(op2))
